...
suite("Unit Tests", function () {
  ...
  suite("Equality", function () {
    ...
    test("#strictEqual, #notStrictEqual", function () {
      assert.notStrictEqual(6, "6", "not strictly equal");
      assert.strictEqual(6, 3 * 2, "3 * 2 does equal 6");
      assert.strictEqual(6 * "2", 12, "6 * 2 is equal");
      assert.notStrictEqual([1, "a", {}], [1, "a", {}], "not strictly equal");
    });
    // #7
